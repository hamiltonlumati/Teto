...
<body class="bg-light pt-5" style="display: block; width:100%; heigth: 100%">
    ...
    <form action="/login" method="POST" class="mx-auto px-auto card" style="width: 26rem;">
        ...
        <div class="card-body fs-6">
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label mx-auto">Email</label>
                <input type="email" class="form-control" id="formGroupExampleInput" placeholder="nomedousuario@email.com">
            </div>
            <div class="mb-3">
